...
const integrations: Integration[] = [
  ...
  },
  {
    ...
    description:
      'Integrate product updates into your lead management workflow. Tag features with Companies and customers that have asked for them, and trigger automated updates when these features are completed.',
    enabled: false,
  },
  {
    title: 'Hubspot',
    ...
    description:
      'You have email automation workflows already built out, and want to sync them to your source of truth for lead management. Syncing prospects and Companies into HubSpot means uploading large CSVs... or turning on the one-click integration below.',
    enabled: false,
  },
];
